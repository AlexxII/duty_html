  ...
  function render() {
    root.innerHTML = `
      ...
      <div class="csv-help">
        ...
        <div class="csv-help__desc">
          Разделитель: <b>;</b><br>
          Пустые значения: <b>-</b><br>
          Несколько телефонов: через запятую
        </div>

        <pre class="csv-help__example">
  id;ФИО;звание;должность;подразделение;телефон АТС-ОГВ;мобильный телефон;адрес проживания;номер личного оружия;номер индивидуального оружия;домашний городской телефон;второй мобильный телефон
  1;Иванов И.И.;капитан;дежурный;1 отдел;123-45-67;9000000000;г. Москва;-;-;-;9000000001
  2;Петров П.П.;майор;начальник;2 отдел;234-56-78;9111111111,9222222222;г. СПб;A123;B456;8123456789;-
        </pre>
        <div class=""
      </div>
